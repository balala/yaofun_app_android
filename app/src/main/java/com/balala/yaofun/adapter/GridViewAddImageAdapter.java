...
//
//    public GridViewAddImageAdapter(ArrayList<Map<String, Object>> datas, Context context) {
//        this.datas = datas;
...
//    }
//
//    public void notifyDataSetChanged(ArrayList<Map<String, Object>> datas) {
//        this.datas = datas;
...
//            final File file = new File("https://test.yaofun.vip/api/activity/upload/more/image");
...
//
//            Picasso.with(context)
//                    .load(R.drawable.createfunuploading)
////                    .priority(Priority.HIGH)
////                    .centerCrop()
//                    .into(viewHolder.ivimage);
...
//            ivimage = (ImageView) root.findViewById(R.id.image);
